...
+ [Migrating from platform version 1\.3\.0 to 1\.4\.0](#platform-version-migration)
...
+ Beginning on May 28, 2020, any new Fargate task that is launched using platform version 1\.4\.0 will have its 20 GB ephemeral storage encrypted with an AES\-256 encryption algorithm using an AWS Fargate\-managed encryption key\. For more information, see [Fargate Task Storage](fargate-task-storage.md)\.
...
## Migrating from platform version 1\.3\.0 to 1\.4\.0<a name="platform-version-migration"></a>
