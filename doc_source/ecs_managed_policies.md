...
This IAM trust relationship policy allows containers in your Amazon ECS tasks to make calls to the AWS APIs on your behalf\. For more information, see [**Amazon EC2 Container Service Task Role**](task_IAM_role.md)\.
