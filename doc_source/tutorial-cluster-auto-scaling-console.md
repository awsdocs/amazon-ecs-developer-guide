# Tutorial: Using cluster auto scaling with the AWS Management Console and the classic Amazon ECS console<a name="tutorial-cluster-auto-scaling-console"></a>
