...
+ Your Amazon ECS tasks must be placed in the same VPC as your Container Instance\. Tasks will fail to start with with an attribute error if they not in the same VPC\.
