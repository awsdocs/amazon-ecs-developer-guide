...
1. View the container logs in the CloudWatch Logs console\.
   ...
   1. Scroll down to view the last lines of the log stream\. You should see the output of the aws ecs list\-tasks command\.
      ...
      + The IAM roles for tasks feature is not enabled on your container instances\. For more information, see [Enabling task IAM roles on your Amazon EC2 or external instances](task-iam-roles.md#enable_task_iam_roles)\.
