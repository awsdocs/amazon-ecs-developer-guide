# Run a standalone task using the new Amazon ECS console<a name="ecs_run_task-v2"></a>
...
1. \(Optional\) Choose how your task is distributed across your cluster infrastructure\. Expand **Compute configuration**, and then choose your option\.    
[\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs_run_task-v2.html)
