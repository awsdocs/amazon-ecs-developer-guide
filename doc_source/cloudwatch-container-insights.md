...
## To change the default for Container Insights for all users using the console<a name="w193aac30c29c15"></a>
...
## To change the default for Container Insights for all users using the command line<a name="w193aac30c29c17"></a>
...
## To change the default for Container Insights for a specific user using the command line<a name="w193aac30c29c19"></a>
...
## To turn on Container Insights for a specific cluster using the command line<a name="w193aac30c29c21"></a>
