...
+ Amazon ECS service auto scaling is supported when using the blue/green deployment type\. The following should be considered when using service auto scaling:
