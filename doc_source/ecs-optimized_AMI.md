...
+ [Linux Amazon ECS\-optimized AMIs](#ecs-optimized-ami-linux)
+ [Windows Amazon ECS\-optimized AMIs](#ecs-optimized-ami-windows)
...
The following tabs display details about the Windows variants of the Amazon ECS\-optimized AMI\. You can subscribe to the Windows AMI Amazon SNS topics to be notified when a new AMI is released or an AMI version is marked private\. For more information, see [Windows Amazon ECS\-optimized AMIs](ECS-AMI-SubscribeTopic.md#sns-topic-windows)\.
