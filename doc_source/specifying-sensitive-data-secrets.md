...
**Topics**
+ [Considerations for Specifying Sensitive Data Using Secrets Manager](#secrets-considerations)
...
+ [Creating a Task Definition that References Sensitive Data](#secrets-create-taskdefinition)
