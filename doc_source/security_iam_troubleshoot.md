# Troubleshooting Amazon Elastic Container Service Identity and Access<a name="security_iam_troubleshoot"></a>
...
## I'm an Administrator and Want to Allow Others to Access Amazon ECS<a name="security_iam_troubleshoot-admin-delegate"></a>
