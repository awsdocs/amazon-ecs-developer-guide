...
+ [New Amazon Elastic Container Service console](new-console.md)
   + [Getting started using the new Amazon ECS console](available-getting-started.md)
   ...
   + [Task definition management in the new Amazon ECS console](available-task-definition-actions.md)
      ...
      + [Deregistering a task definition revision using the new console](deregister-task-definition-v2.md)
