...
[Step 1: Create the Service Discovery Namespace and Service ](#create-service-discovery-namespace)

[Step 2: Create a Cluster](#create-service-discovery-cluster)

[Step 3: Register a Task Definition](#create-service-discovery-taskdef)
...
## Step 2: Create a Cluster<a name="create-service-discovery-cluster"></a>
...
## Step 3: Register a Task Definition<a name="create-service-discovery-taskdef"></a>
...
## Step 4: Create a Service<a name="create-service-discovery-service"></a>
...
## Step 6: Clean Up<a name="create-service-discovery-cleanup"></a>
...
1. Update the Amazon ECS service so the desired count is `0`, which allows you to delete it\.
