...
+ If you configure your Application Load Balancer to use slow start mode, you must configure your task health check to return an `UNHEALTHY` status until after the slow start period is over\. For more information about slow start mode, see [Target Groups for Your Application Load Balancers](https://docs.aws.amazon.com/elasticloadbalancing/latest/application/load-balancer-target-groups.html)\.
