...
+ An Amazon EC2 Linux instance running on your default ECS cluster\. If you need to create these resources, see [Getting started with the Amazon ECS console using AWS Fargate](getting-started-fargate.md)\.
