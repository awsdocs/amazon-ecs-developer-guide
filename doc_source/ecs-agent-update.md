...
![\[Container instance agent version\]](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/images/cluster_container_instance_tab.png)
   ...
   If your agent version is 1\.16\.1, you are running the latest container agent\. If your agent version is below 1\.16\.1, you can update your container agent with the following procedures:
...
1. Query the introspection API\.
   ...
   ```
   {
       ...
       "Version": "Amazon ECS Agent - v1.16.1 (ea383f2)"
   }
   ```
**Note**  
